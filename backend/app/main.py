...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5174", "http://192.168.1.81:5174", "https://api.synthflow.ai", "*"],
...
app.include_router(property_contacts.router)  # Property contacts and tasks
